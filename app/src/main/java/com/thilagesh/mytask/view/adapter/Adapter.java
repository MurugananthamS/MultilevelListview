...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        switch (model.state) {
            ...
            case CLOSED:
                holder.imgArrow.setImageResource(R.drawable.ic_keyboard_arrow_down_black_24dp);
                break;
            case OPENED:
                holder.imgArrow.setImageResource(R.drawable.ic_keyboard_arrow_up_black_24dp);
                break;
        }
